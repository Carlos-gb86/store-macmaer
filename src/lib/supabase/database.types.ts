...
"cart_id": string | null;
"status": "PENDING_PAYMENT" | "PAID" | "PROCESSING" | "READY_TO_SHIP" | "SHIPPED" | "DELIVERED" | "CANCELLED" | "PARTIALLY_REFUNDED" | "REFUNDED";
...
"discount_amount": number;
"merchandise_net_amount": number;
"merchandise_tax_amount": number;
...
"status": "NOT_STARTED" | "REQUIRES_PAYMENT" | "PROCESSING" | "SUCCEEDED" | "FAILED" | "PARTIALLY_REFUNDED" | "REFUNDED" | "DISPUTED";
"amount": number;
"currency": string;
